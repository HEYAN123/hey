module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro.v4': 'Hey Design Pro v4',
    ...
    'app.home.design-values-description':
      'This is an internal criterion for Hey Design to evaluate good design. Based on the postulate that "everyone pursues pleasure at work", we have added the two values of "Meaningful" and "Growing" on the basis of "Certain" and "Natural" to guide each designer to do better judgment and decision.',
    ...
    'app.home.product-mobile-slogan': 'Mobile UI components with Hey Design',
    ...
    'app.footer.awesome': 'Awesome Hey Design',
    'app.footer.course': 'Hey Design Practical Tutorial',
    ...
    'app.footer.zhihu': 'Hey Design Blog',
