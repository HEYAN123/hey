module.exports = {
  ...
  messages: {
    ...
    'app.home.introduce': '基于react的配置化组件库',
    'app.home.special': '为什么要用',
    ...
    'app.home.design-values-description':
      '这是 Hey Design 评价设计好坏的内在标准。基于「每个人都追求快乐工作」这一假定，我们在「确定性」和「自然」的基础上，新增「意义感」和「生长性」两个价值观，指引每个设计者做更好地判断和决策。',
    ...
    'app.footer.course': 'Hey Design 实战教程',
    ...
    'app.footer.zhihu': 'Hey Design 专栏',
