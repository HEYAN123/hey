...
Hey Design React is dedicated to providing a **good development experience** for programmers. Make sure that you have installed [Node.js](https://nodejs.org/)(> 8.0.0) correctly.
...
> Before delving into Hey Design React, a good knowledge base of [React](https://reactjs.org) and [JavaScript ES2015](http://babeljs.io/docs/learn-es2015/) is needed.

---

## First Example

Here is a simple codesandbox example to show the usage of Hey Design React.
...
- [Hey Design Pro](http://pro.ant.design/)
...
Hey Design React supports all modern browsers and IE11+.
...
Hey Design 3.0 supports both React 15 and 16 but we strongly suggest React 16 for better performance and fewer bugs.
