...
Following the Hey Design specification, we developed a React UI library `antd` that contains a set of high quality components and demos for building rich, interactive user interfaces.
...
- [Hey Design Icons](https://github.com/ant-design/ant-design-icons)
- [Hey Design Colors](https://github.com/ant-design/ant-design-colors)
- [Hey Design Pro Layout](https://github.com/ant-design/ant-design-pro-layout)
- [Hey Design Pro Blocks](https://github.com/ant-design/pro-blocks)
...
> If your company or product uses Hey Design, let us know [here](https://github.com/ant-design/ant-design/issues/477)!
