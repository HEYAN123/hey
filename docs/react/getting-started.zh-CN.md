...
这是一个最简单的 Hey Design 组件的在线 codesandbox 演示。
...
Hey Design React 支持所有的现代浏览器和 IE11+。
...
Hey Design 3.0 对 React 15/16 两个版本提供支持，但是我们强烈建议你升级到 React 16，以便获得更好的性能和遇到更少的问题。
