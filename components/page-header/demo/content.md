...
```jsx
import { PageHeader, Menu, Dropdown, Button, Tag, Typography, Row } from 'hey-design';
...
const content = (
  <>
    <Paragraph>
      Hey Design interprets the color system into two levels: a system-level color system and a
      product-level color system.
    </Paragraph>
    <Paragraph>
      Hey Design&#x27;s design team preferred to design with the HSB color model, which makes it
