...
```jsx
import { Typography, Divider } from 'hey-design';
...
ReactDOM.render(
  <Typography>
    ...
    <Paragraph>
      After massive project practice and summaries, Hey Design, a design language for background
    ...
    <Paragraph>
      ...
      Hey Design。基于<Text mark>『确定』和『自然』</Text>
